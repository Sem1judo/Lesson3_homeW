...
import taks_3_2.model.ShopModel;
import taks_3_2.model.entity.Shop;
import taks_3_2.view.InputData;
import taks_3_2.view.ShopView;
...
public class ShopController {
    ...
    public void run() {
        ...
        shopView.viewData("--------------------------");
        shopView.viewData(ConvertToString.convertArrayDepartments(shopModel.sortDepartment(new Comparator<Shop.Department>() {
